...
import { logo2, githubLogo } from "../../assets/index";
    ...
    return(
        ...
        <div className="w-full h-20 bg-white border-b-[1px] border-b-gray-800">
            ...
            <div>
                ...
                <Image src="https://images.pexels.com/photos/2235130/pexels-photo-2235130.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1" width="58" height="10"></Image>
                </div>
                <div>
                <ul className="flex items-center gap-8 left-3  ">
